...
public class XianhuaLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XianhuaLiuyanEntity() {

	}

	public XianhuaLiuyanEntity(T t) {
		try {
     ...
     * 留言内容
     */
    @TableField(value = "xianhua_liuyan_text")
    ...
    public String toString() {
        return "XianhuaLiuyan{" +
            "id=" + id +
            ", xianhuaId=" + xianhuaId +
            ", yonghuId=" + yonghuId +
            ", xianhuaLiuyanText=" + xianhuaLiuyanText +
            ", replyText=" + replyText +
