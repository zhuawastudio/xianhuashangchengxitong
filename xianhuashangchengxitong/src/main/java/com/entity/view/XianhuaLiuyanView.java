 ...
 */
@TableName("xianhua_liuyan")
public class XianhuaLiuyanView extends XianhuaLiuyanEntity implements Serializable {
	...
	public XianhuaLiuyanView() {

	}

	public XianhuaLiuyanView(XianhuaLiuyanEntity xianhuaLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, xianhuaLiuyanEntity);
